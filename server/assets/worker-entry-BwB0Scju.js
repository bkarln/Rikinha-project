...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Blv14rWV.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BzGgUTP_.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "Rikinha-project";
var SERVER_FN_BASE = "/Rikinha-project/_serverFn/";
