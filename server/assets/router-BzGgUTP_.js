...
const appCss = "/Rikinha-project/assets/styles-D8kdf2xu.css";
...
function Logo({ variant = "dark" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-serif text-3xl font-bold tracking-tight ${color}`, children: "JR" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] tracking-[0.3em] ${variant === "dark" ? "text-navy/70" : "text-cream/70"}`, children: "CONSULTING" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { width: "28", height: "10", viewBox: "0 0 60 12", className: "text-gold -ml-1 mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M2 8 Q20 -2 58 6", stroke: "currentColor", strokeWidth: "2.5", fill: "none", strokeLinecap: "round" }) })
  ] });
}
const links = [
  { to: "/", label: "Início" },
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-cream/85 backdrop-blur-md border-b border-border/60", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 lg:px-10 flex items-center justify-between h-20", children: [
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden border-t border-border bg-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "container mx-auto px-6 py-4 flex flex-col gap-3", children: [
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-navy text-navy-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 lg:px-10 py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 lg:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-cream/95 inline-block px-4 py-3 rounded-md mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream/70 text-sm leading-relaxed", children: "Conectamos oportunidades. Entregamos resultados." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "text-gold", size: 20 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-lg text-cream", children: "Atuação Global" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream/70 text-sm", children: "China e outros países com os melhores fornecedores." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "text-gold", size: 20 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-lg text-cream", children: "Contato" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream/70 text-sm", children: "+55 (11) 9 0000-0000" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-cream/70 text-sm flex items-center gap-2 mt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 14 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "contato@jrconsulting.com.br" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "text-gold", size: 20 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-serif text-lg text-cream", children: "Onde Você Estiver" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream/70 text-sm", children: "Atendemos empresas em todo o Brasil." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-cream/10 mt-12 pt-6 flex flex-col md:flex-row justify-between gap-4 text-xs text-cream/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " JR Consulting. Todos os direitos reservados."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/servicos", className: "hover:text-gold", children: "Serviços" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/blog", className: "hover:text-gold", children: "Blog" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contato", className: "hover:text-gold", children: "Contato" })
      ] })
    ] })
  ] }) });
}
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-cream px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-serif font-bold text-navy", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold text-navy", children: "Página não encontrada" }),
...
const $$splitComponentImporter$6 = () => import("./sobre-B_3Pbgbb.js");
const Route$6 = createFileRoute("/sobre")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A JR Consulting conecta empresas brasileiras aos melhores fornecedores internacionais. Conheça nossa história e valores."
    }, {
      property: "og:title",
      content: "Sobre a JR Consulting"
    }, {
      property: "og:description",
      content: "Conectamos oportunidades. Entregamos resultados."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./servicos-C7wRnOLM.js");
const Route$5 = createFileRoute("/servicos")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Busca de fornecedores, negociação estratégica, gestão de importação e consultoria internacional para empresas brasileiras."
    }, {
      property: "og:title",
      content: "Serviços de Importação — JR Consulting"
    }, {
      property: "og:description",
      content: "Da busca de fornecedores à entrega no Brasil. Conheça os serviços da JR Consulting."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./processo-BiFqKid4.js");
const Route$4 = createFileRoute("/processo")({
  head: () => ({
    meta: [{
      title: "Como Trabalhamos — JR Consulting"
    }, {
      name: "description",
      content: "Conheça as 5 etapas do nosso método de importação: análise, pesquisa, negociação, importação e resultados."
    }, {
      property: "og:title",
      content: "Nosso processo de importação — JR Consulting"
    }, {
      property: "og:description",
      content: "Cinco etapas claras para importar com segurança e economia."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./contato-DAqm_cDf.js");
const Route$3 = createFileRoute("/contato")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Fale com a JR Consulting. Solicite uma consulta gratuita sobre sua próxima importação da China."
    }, {
      property: "og:title",
      content: "Entre em contato — JR Consulting"
    }, {
      property: "og:description",
      content: "Solicite uma consulta sobre sua próxima importação."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-B75FWuIJ.js");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Consultoria especializada em importação da China. Buscamos fornecedores, negociamos preços e gerenciamos todo o processo de importação para sua empresa."
    }, {
      property: "og:title",
      content: "JR Consulting — Importe melhor. Compita melhor."
    }, {
      property: "og:description",
      content: "Seu consultor e comprador particular para compras internacionais."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./blog.index-CwzS3n5l.js");
const Route$1 = createFileRoute("/blog/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Artigos práticos sobre importação, negociação com fornecedores chineses e logística internacional para empresas brasileiras."
    }, {
      property: "og:title",
      content: "Blog — JR Consulting"
    }, {
      property: "og:description",
      content: "Insights práticos sobre importação da China, negociação e logística internacional."
    }]
  }),
...
const posts = [
  {
    ...
    excerpt: "Um guia prático para empresários brasileiros que querem reduzir riscos, evitar golpes e garantir qualidade na origem.",
    date: "2026-04-12",
    readingTime: "6 min",
    category: "Importação",
  ...
  },
  {
    ...
    excerpt: "Entender a cultura de negócios na Ásia muda completamente o resultado da sua próxima cotação.",
    date: "2026-03-28",
    readingTime: "5 min",
    category: "Negociação",
    author: "Equipe JR Consulting",
  ...
  },
  {
    ...
    excerpt: "Frete, impostos, armazenagem, demurrage. Saiba o que entra no custo real do produto antes de precificar.",
    date: "2026-03-10",
    readingTime: "7 min",
    category: "Logística",
    author: "Equipe JR Consulting",
...
const $$splitComponentImporter = () => import("./blog._slug-DZNMu4Fu.js");
const $$splitNotFoundComponentImporter = () => import("./blog._slug-2hdtw1vM.js");
const $$splitErrorComponentImporter = () => import("./blog._slug-B5yRNB9D.js");
const Route2 = createFileRoute("/blog/$slug")({
  ...
  head: ({
    ...
    if (!post) {
      return {
        meta: [{
          title: "Artigo não encontrado — JR Consulting"
        }]
      };
    }
    return {
...
const ProcessoRoute = Route$4.update({
  id: "/processo",
  path: "/processo",
  getParentRoute: () => Route$7
});
